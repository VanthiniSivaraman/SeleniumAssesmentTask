...
public class LoadData {
	...
	public void readWriteExcelFile()     
	{ 
		try
		{    
			// Get the sheet at location num-1
			Workbook workBook = WorkbookFactory.create(new File(System.getProperty("user.dir") + "//YatraData.xlsx"));
			XSSFSheet sheet = (XSSFSheet) workBook.getSheetAt(0);   

			// Creating HashMap where all the extracted data will be stored
			HashMap< String, String > properties = new HashMap< String, String >();
			properties.put("FILENAME",workBook.getSheetName(0));
	...
	public HashMap< String, String > readRow(HashMap< String, String > properties, XSSFRow row, int num)
	{
		...
		String[] keys= { "Url"+num, "From"+num, "To"+num};
	...
	public void writeData(HashMap< String, String > properties) throws FileNotFoundException
	{
		...
		String propertiesPath= System.getProperty("user.dir") + "//src//main//java//ExtractData//data.properties";
